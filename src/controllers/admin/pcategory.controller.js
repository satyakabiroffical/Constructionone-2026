...
export const createPcategory = catchAsync(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(201, pcategory, "Pcategory created successfully"));
});
...
export const getAllPcategories = catchAsync(async (req, res) => {
    ...
    return res
      ...
      .json(
        new ApiResponse(
          200,
          cached,
          "Pcategories fetched successfully (cached)",
        ),
      );
  ...
  res
    .status(200)
    .json(new ApiResponse(200, result, "Pcategories fetched successfully"));
});
...
export const getPcategoryById = catchAsync(async (req, res) => {
    ...
    return res
      ...
      .json(
        new ApiResponse(
          200,
          cached,
          "Pcategory details fetched successfully (cached)",
        ),
      );
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, pcategory, "Pcategory details fetched successfully"),
    );
});
...
export const updatePcategory = catchAsync(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, pcategory, "Pcategory updated successfully"));
});
...
export const deletePcategory = catchAsync(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, null, "Pcategory deleted successfully"));
});
...
export const togglePcategory = catchAsync(async (req, res) => {
  ...
  res
    ...
    .json(
      new ApiResponse(
        200,
        { isActive: pcategory.isActive },
        `Pcategory is now ${pcategory.isActive ? "active" : "inactive"}`,
      ),
    );
});
