...
export const getAllSubCategories = catchAsync(async (req, res) => {
    ...
    return res
      ...
      .json(
        new ApiResponse(
          200,
          cached,
          "SubCategories fetched successfully (cached)",
        ),
      );
  ...
  res
    .status(200)
    .json(new ApiResponse(200, result, "SubCategories fetched successfully"));
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          200,
          cached,
          "SubCategory details fetched successfully (cached)",
        ),
      );
  ...
  res
    ...
    .json(
      new ApiResponse(
        200,
        subCategory,
        "SubCategory details fetched successfully",
      ),
    );
});
  ...
  res
    ...
    .json(
      new ApiResponse(
        200,
        { isActive: subCategory.isActive },
        `SubCategory is now ${subCategory.isActive ? "active" : "inactive"}`,
      ),
    );
});
